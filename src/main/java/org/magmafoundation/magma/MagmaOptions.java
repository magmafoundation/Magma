 ...
 * @since 24/11/2019 - 06:11 am
 */
public class MagmaOptions {
    ...
    public static OptionSet main(String[] args) {
        ...
        OptionParser parser = new OptionParser() {
            {
                ...
                acceptsAll(asList("W", "world-dir", "universe", "world-container"),
                        "World container")
                        .withRequiredArg()
                        .ofType(File.class)
                ...
                acceptsAll(asList("d", "date-format"),
                ...
                acceptsAll(asList("mixin"),
                        "This argument is needed for proper Mixin Framework work in the test env");
                ...
                acceptsAll(asList("gameDir"), "Server Location")
                        .withRequiredArg()
                        .ofType(File.class)
                        .defaultsTo(new File("."))
                        .describedAs("Game Location");
            }
        };
        ...
        try {
            ...
            Logger.getLogger(MagmaOptions.class.getName())
        ...
        if ((options == null) || (options.has("?"))) {
            try {
                ...
                Logger.getLogger(MagmaOptions.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            ...
            try {
                ...
                String jline_UnsupportedTerminal = new String(
                        new char[]{'j', 'l', 'i', 'n', 'e', '.', 'U', 'n', 's', 'u', 'p', 'p', 'o', 'r',
                                't', 'e', 'd', 'T', 'e', 'r', 'm', 'i', 'n', 'a', 'l'});
                String jline_terminal = new String(
                        new char[]{'j', 'l', 'i', 'n', 'e', '.', 't', 'e', 'r', 'm', 'i', 'n', 'a',
                                'l'});
